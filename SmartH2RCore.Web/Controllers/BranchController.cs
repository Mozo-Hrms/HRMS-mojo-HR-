...
namespace SmartH2RCore.Web.Controllers
{
    public class BranchController : BaseController
    {
        ...
        {
            var BranchAll = await _branchService.GetAll().Select(d => new { d.Id, d.LocationName }).ToListAsync();
            return new JsonResult(BranchAll);
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                await _branchService.DeleteHardAsync(id);
