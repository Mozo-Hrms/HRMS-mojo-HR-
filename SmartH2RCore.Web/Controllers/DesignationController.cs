...
namespace SmartH2RCore.Web.Controllers
{
    public class DesignationController : BaseController
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllDesgination()  //to display data in department dropdownlist
        {
            var DepartmentAll = await _designationService.GetAll().Select(d => new { d.Id, d.Name }).ToListAsync();
