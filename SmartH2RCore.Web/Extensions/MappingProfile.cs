...
namespace SmartH2RCore.Web.Extensions
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<LocalizatonSettingDTO, LocalizationSetting>().ReverseMap();
            CreateMap<ThemeSettingsDTO, ThemeSettings>().ReverseMap();
            CreateMap<ChangePasswordDTO, ChangePassword>().ReverseMap();
            CreateMap<AssetSettingDTO, AssetSetting>().ReverseMap();
            CreateMap<JobDetailsDTO, JobDetails>().ReverseMap();
