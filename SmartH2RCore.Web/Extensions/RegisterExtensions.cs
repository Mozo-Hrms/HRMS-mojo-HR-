...
namespace SmartH2RCore.Web.Extensions
{
    internal static class RegisterExtensions
    {
        ...
        internal static void AddInjections(this IServiceCollection services)
        {
            ...
            services.AddTransient(typeof(ILocalizationSettingService), typeof(LocalizationSettingService));
            services.AddTransient(typeof(IThemeSettingsService), typeof(ThemeSettingsService));
            services.AddTransient(typeof(IChangePasswordService), typeof(ChangePasswordService));
            services.AddTransient(typeof(IAssetSettingService), typeof(AssetSettingService));
          //  Employee Services
